(function () {
    ...
    angular
        ...
        .controller('SeedUpdateController', SeedUpdateController);
    SeedUpdateController.$inject = ['Seed', '$state', 'Snackbar', 'Authentication', '$scope'];


    function SeedUpdateController(Seed, $state, Snackbar, Authentication, $scope) {
        var vm = this;
        activate();
